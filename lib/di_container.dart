...
Future<void> init() async {
  ...
  // sl.registerLazySingleton(() => TripsRepo(sharedPreferences: sl(), dioClient: sl()));
  // sl.registerLazySingleton(() => BookingRepo(sharedPreferences: sl(), dioClient: sl()));
  // sl.registerLazySingleton(() => TicketsRepo(sharedPreferences: sl(), dioClient: sl()));
  // sl.registerLazySingleton(() => UserTripsRepo(sharedPreferences: sl(), dioClient: sl()));
  ...
  // sl.registerFactory(() => TripsProvider(tripsRepo: sl()));
  // sl.registerFactory(() => BookingProvider(bookingRepo: sl()));
  // sl.registerFactory(() => TicketsProvider(ticketsRepo: sl()));
  // sl.registerFactory(() => UserTripsProvider(userTripsRepo: sl()));
